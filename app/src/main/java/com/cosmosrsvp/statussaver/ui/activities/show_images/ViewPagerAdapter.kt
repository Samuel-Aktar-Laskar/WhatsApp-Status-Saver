...
constructor(
    ...
    ): RecyclerView.Adapter<ViewPagerAdapter.ViewHolder>(), OnPause {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if (file.isVideo()){
            try {
                ...
                val playerView2: StyledPlayerView=StyledPlayerView(context)
            ...
            val imageView2: SubsamplingScaleImageView= SubsamplingScaleImageView(context)
            imageView2.setImage(ImageSource.uri(file.absolutePath))
            holder.frameLayout.addView(imageView2)
        }
    }

    override fun stopThePlayer() {
